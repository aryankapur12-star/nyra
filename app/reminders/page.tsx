...
function fmtDateTime(d:string){if(!d)return '—';return new Date(d).toLocaleDateString('en-CA',{month:'short',day:'numeric',year:'numeric'});}
...
export default function RemindersPage(){
  ...
  const upcoming=bills.filter(b=>b&&b.due_date&&daysUntil(b.due_date)>=0&&daysUntil(b.due_date)<=7).sort((a,b)=>daysUntil(a.due_date)-daysUntil(b.due_date));
